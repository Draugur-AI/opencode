...
`e2e (linux/windows)` is now part of the gate too (TKT-336 retargeted it off blacksmith; it was
never running before, just queued forever). `nix-eval` and `/review` remain outside the gate
