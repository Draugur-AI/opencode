...
const icons = {
  ...
  // Copied from the V1 icon set (packages/ui/src/components/icon.tsx) rather than mixing
  // component versions in one view -- neither existed in V2 yet, TKT-314 needed both for the
  // Archived/Trash views' restore and delete-permanently actions.
  trash: {
    viewBox: "0 0 20 20",
  ...
  star: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.6L9.8808 5.65147L14.4 6.29868L11.12 9.41111L11.8829 13.8813L8 11.8318L4.11713 13.8813L4.88 9.41111L1.6 6.29868L6.1192 5.65147L8 1.6Z" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"/>`,
  },
  "star-active": {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.6L9.8808 5.65147L14.4 6.29868L11.12 9.41111L11.8829 13.8813L8 11.8318L4.11713 13.8813L4.88 9.41111L1.6 6.29868L6.1192 5.65147L8 1.6Z" fill="currentColor"/>`,
  },
}
