export const dict = {
  ...
  "command.session.goal": "Doel & statenboek",
  "command.session.goal.description": "Open het paneel voor sessiedoel en werkstatenboek",
  ...
  "goal.objective.title": "Doelstelling",
  "goal.objective.placeholder": "Wat wil deze sessie bereiken?",
  "goal.empty": "Er is nog geen doel ingesteld voor deze sessie.",
  "goal.setGoal": "Doel instellen",
  "goal.acceptanceCriteria.title": "Acceptatiecriteria",
  "goal.acceptanceCriteria.empty": "Nog geen acceptatiecriteria.",
  "goal.acceptanceCriteria.met": "Voldaan",
  "goal.acceptanceCriteria.waive": "Uitzondering",
  "goal.constraints.title": "Beperkingen",
  "goal.constraints.empty": "Nog geen beperkingen.",
  "goal.constraints.fromMessage": "Van bericht",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "De doelstelling mag niet leeg zijn",
  "goal.toast.saved": "Doel opgeslagen",
  "goal.ledger.title": "Werkstatenboek",
  "goal.ledger.empty": "Nog geen entry's in het statenboek.",
  "goal.ledger.supersede": "Vervangen",
  ...
  "home.inventory.servers": "Servers",
  "home.inventory.favorites": "Favorieten",
  "home.inventory.recent": "Recent",
  "home.inventory.all": "Alles",
  "home.inventory.favorite": "Toevoegen aan favorieten",
  "home.inventory.unfavorite": "Verwijderen uit favorieten",
  ...
  "archived.title": "Gearchiveerd",
  "archived.empty": "Geen gearchiveerde sessies",
  "trash.title": "Prullenbak",
  "trash.empty": "Prullenbak is leeg",
  "trash.deletePermanently": "Definitief verwijderen",
  "trash.deleteConfirm.title": "Definitief verwijderen?",
  "trash.deleteConfirm.description": "Hierdoor wordt \"{{title}}\" permanent verwijderd, inclusief transcript, gebeurtenissen, doelen, ledger en bijbehorende monitorregisters. Dit kan niet ongedaan worden gemaakt.",
  "session.tab.session": "Sessie",
  "session.tab.review": "Beoordeling",
  "session.tab.context": "Context",
  "session.tab.goal": "Doel",
