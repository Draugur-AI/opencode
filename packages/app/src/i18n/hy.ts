export const dict = {
  ...
  "archived.title": "Արխիվ",
  "archived.empty": "Չկան թաղված նիստեր",
  "trash.title": "Աղբաման",
  "trash.empty": "Աղբամանը դատարկ է",
  "trash.deletePermanently": "Մշտապես ջնջել",
  "trash.deleteConfirm.title": "Մշտապես՞ ջնջել",
  "trash.deleteConfirm.description": "Սա մշտապես կջնջի «{{title}}»-ը և դրա տառադարձությունը, իրադարձությունները, նպատակները, գրառումը և սեփական մոնիտորի գրառումները։ Սա հնարավոր չէ վերացնել:",
