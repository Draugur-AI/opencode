export const dict = {
  ...
  "command.session.goal": "Objectiu i registre",
  "command.session.goal.description": "Obre el tauler d'objectiu de la sessió i registre de treball",
  ...
  "goal.objective.title": "Objectiu",
  "goal.objective.placeholder": "Què vol aconseguir aquesta sessió?",
  "goal.empty": "Encara no s'ha establert cap objectiu per a aquesta sessió.",
  "goal.setGoal": "Estableix l'objectiu",
  "goal.acceptanceCriteria.title": "Criteris d'acceptació",
  "goal.acceptanceCriteria.empty": "Encara no hi ha criteris d'acceptació.",
  "goal.acceptanceCriteria.met": "Complit",
  "goal.acceptanceCriteria.waive": "Abdiqueu",
  "goal.constraints.title": "Restriccions",
  "goal.constraints.empty": "Encara no hi ha restriccions.",
  "goal.constraints.fromMessage": "Des del missatge",
  "goal.status.title": "Estat",
  "goal.toast.objectiveRequired": "L'objectiu no pot estar buit",
  "goal.toast.saved": "Objectiu desat",
  "goal.ledger.title": "Llibre de treball",
  "goal.ledger.empty": "Encara no hi ha entrades al llibre.",
  "goal.ledger.supersede": "Substitueix",
  "language.en": "Anglès",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Servidors",
  "home.inventory.favorites": "Preferits",
  "home.inventory.recent": "Recents",
  "home.inventory.all": "Tot",
  "home.inventory.favorite": "Afegeix als preferits",
  "home.inventory.unfavorite": "Elimina dels preferits",
