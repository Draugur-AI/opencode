...
export const dict = {
  ...
  "command.session.goal": "Cél és főkönyv",
  "command.session.goal.description": "Munkamenetcél és dolgozó főkönyv panel megnyitása",
  ...
  "goal.objective.title": "Célkitűzés",
  "goal.objective.placeholder": "Mi lenne ezentúl a cél?",
  "goal.empty": "A munkamenetnek még nincs célja.",
  "goal.setGoal": "Cél beállítása",
  "goal.acceptanceCriteria.title": "Elfogadási kritériumok",
  "goal.acceptanceCriteria.empty": "Még nincsenek elfogadási kritériumok.",
  "goal.acceptanceCriteria.met": "Teljesítve",
  "goal.acceptanceCriteria.waive": "Mellőzés",
  "goal.constraints.title": "Korlátozások",
  "goal.constraints.empty": "Még nincsenek korlátozások.",
  "goal.constraints.fromMessage": "Üzenetből",
  "goal.status.title": "Állapot",
  "goal.toast.objectiveRequired": "A célkitűzés nem lehet üres",
  "goal.toast.saved": "Cél mentve",
  "goal.ledger.title": "Dolgozó főkönyv",
  "goal.ledger.empty": "Még nincsenek főkönyvi bejegyzések.",
  "goal.ledger.supersede": "Felváltás",
  "language.en": "angol",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Szerverek",
  "home.inventory.favorites": "Kedvencek",
  "home.inventory.recent": "Nemrégiek",
  "home.inventory.all": "Összes",
  "home.inventory.favorite": "Hozzáadás a kedvencekhez",
  "home.inventory.unfavorite": "Eltávolítás a kedvencekből",
  ...
  "archived.title": "Archivált",
  "archived.empty": "Nincs archivált munkamenet",
  "trash.title": "Kuka",
  "trash.empty": "A kuka üres",
  "trash.deletePermanently": "Végleges törlés",
  "trash.deleteConfirm.title": "Véglegesen töröli?",
  "trash.deleteConfirm.description": "Ez a művelet véglegesen törli a \"{{title}}\" munkamenetet és minden hozzá tartozó adatot (rögzítést, eseményeket, célokat, főkönyvet és tulajdonos monitor rekordokat). A művelet nem vonható vissza.",
  "common.restore": "Visszaállítás",
  "session.tab.session": "Munkamenet",
  "session.tab.review": "Tekintse át",
  "session.tab.context": "Kontextus",
  "session.tab.goal": "Cél",
