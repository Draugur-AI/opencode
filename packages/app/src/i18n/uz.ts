export const dict = {
  ...
  "command.session.goal": "Maqsad va jurnal",
  "command.session.goal.description": "Seans maqsadi va ish jurnalini ochish paneli",
  ...
  "goal.objective.title": "Maqsad",
  "goal.objective.placeholder": "Ushbu seans nima qilishni maqsad qilgan?",
  "goal.empty": "Bu sessiya uchun hali maqsad belgilanmagan.",
  "goal.setGoal": "Maqsadni belgilash",
  "goal.acceptanceCriteria.title": "Qabul mezonlari",
  "goal.acceptanceCriteria.empty": "Hali qabul mezonlari yo'q.",
  "goal.acceptanceCriteria.met": "Qondirilgan",
  "goal.acceptanceCriteria.waive": "O'tkazib yuborish",
  "goal.constraints.title": "Cheklovlar",
  "goal.constraints.empty": "Hali cheklovlar yo'q.",
  "goal.constraints.fromMessage": "Xabardan",
  "goal.status.title": "Holat",
  "goal.toast.objectiveRequired": "Maqsad bo'sh bo'lmasligi kerak",
  "goal.toast.saved": "Maqsad saqlandi",
  "goal.ledger.title": "Ish jurnalida",
  "goal.ledger.empty": "Hali jurnal yozuvlari yo'q.",
  "goal.ledger.supersede": "Almashish",
  "language.en": "Ingliz",
  ...
  "home.inventory.servers": "Serverlar",
  "home.inventory.favorites": "Sevimlilar",
  "home.inventory.recent": "So'nggi",
  "home.inventory.all": "Hammasi",
  "home.inventory.favorite": "Sevimlilarga qo'shish",
  "home.inventory.unfavorite": "Sevimlilardan olib tashlash",
  ...
  "archived.title": "Arxivlangan",
  "archived.empty": "Arxivlangan sessiyalar yoʻq",
  "trash.title": "Chiqindi",
  "trash.empty": "Chiqindi boʻsh",
  "trash.deletePermanently": "Doimiy oʻchirish",
  "trash.deleteConfirm.title": "Doimiy oʻchirilsinmi?",
  "trash.deleteConfirm.description": "Bu \"{{title}}\" va uning transkriptini, voqealarini, maqsadlarini, ledgerini va egalik monitoring yozuvlarini doimiy ravishda oʻchiradi. Buni bekor qilib boʻlmaydi.",
  "session.tab.session": "Sessiya",
  "session.tab.review": "Koʻrib chiqish",
  "session.tab.context": "Kontekst",
  "session.tab.goal": "Maqsad",
