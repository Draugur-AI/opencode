export const dict = {
  ...
  "command.session.goal": "Tujuan & buku besar",
  "command.session.goal.description": "Buka panel tujuan dan buku besar kerja sesi",
  ...
  "goal.objective.title": "Tujuan",
  "goal.objective.placeholder": "Apa yang ingin dicapai dalam sesi ini?",
  "goal.empty": "Belum ada tujuan untuk sesi ini.",
  "goal.setGoal": "Atur tujuan",
  "goal.acceptanceCriteria.title": "Kriteria penerimaan",
  "goal.acceptanceCriteria.empty": "Belum ada kriteria penerimaan.",
  "goal.acceptanceCriteria.met": "Terpenuhi",
  "goal.acceptanceCriteria.waive": "Abaikan",
  "goal.constraints.title": "Batasan",
  "goal.constraints.empty": "Belum ada batasan.",
  "goal.constraints.fromMessage": "Dari pesan",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Tujuan tidak boleh kosong",
  "goal.toast.saved": "Tujuan disimpan",
  "goal.ledger.title": "Buku besar kerja",
  "goal.ledger.empty": "Belum ada entri buku besar.",
  "goal.ledger.supersede": "Mengganti",
  ...
  "home.inventory.favorites": "Favorit",
  "home.inventory.recent": "Terbaru",
  "home.inventory.all": "Semua",
  "home.inventory.favorite": "Tambahkan ke favorit",
  "home.inventory.unfavorite": "Hapus dari favorit",
