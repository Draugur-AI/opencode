export const dict = {
  ...
  "home.inventory.favorites": "Вибране",
  "home.inventory.recent": "Нещодавні",
  "home.inventory.all": "Усе",
  "home.inventory.favorite": "Додати до вбраного",
  "home.inventory.unfavorite": "Видалити з вбраного",
  ...
  "command.session.goal": "Ціль і реєстр",
  "command.session.goal.description": "Відкрити панель цілей сесії та рабочого реєстру",
  "goal.objective.title": "Мета",
  "goal.objective.placeholder": "Что хоче досягти ця сесія?",
  "goal.empty": "Для цієї сесії ще не встановлено мету.",
  "goal.setGoal": "Встановити мету",
  "goal.acceptanceCriteria.title": "Критерії прийняття",
  "goal.acceptanceCriteria.empty": "Критерії прийняття ще не вказано.",
  "goal.acceptanceCriteria.met": "Виконано",
  "goal.acceptanceCriteria.waive": "Скасувати",
  "goal.constraints.title": "Обмеження",
  "goal.constraints.empty": "Обмеження ще не вказано.",
  "goal.constraints.fromMessage": "З повідомлення",
  "goal.status.title": "Статус",
  "goal.toast.objectiveRequired": "Мета не може бути порожньою",
  "goal.toast.saved": "Мету збережено",
  "goal.ledger.title": "Робочий реєстр",
  "goal.ledger.empty": "Записів у реєтрі ще немає.",
  "goal.ledger.supersede": "Замінити",
  "session.tab.goal": "Мета",
  "common.add": "Додати",
}
