...
export const dict = {
  ...
  "command.session.goal": "Ziel & Ledger",
  "command.session.goal.description": "Öffnet das Sitzungsziel- und Arbeitsprotokoll-Panel",
  ...
  "goal.objective.title": "Ziel",
  "goal.objective.placeholder": "Was soll mit dieser Sitzung erreicht werden?",
  "goal.empty": "Für diese Sitzung wurde noch kein Ziel festgelegt.",
  "goal.setGoal": "Festlegen",
  "goal.acceptanceCriteria.title": "Abnahmekriterien",
  "goal.acceptanceCriteria.empty": "Noch keine Abnahmekriterien festgelegt.",
  "goal.acceptanceCriteria.met": "Erfüllt",
  "goal.acceptanceCriteria.waive": "Außer Kraft setzen",
  "goal.constraints.title": "Einschränkungen",
  "goal.constraints.empty": "Noch keine Einschränkungen festgelegt.",
  "goal.constraints.fromMessage": "Aus Nachricht",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Das Ziel darf nicht leer sein",
  "goal.toast.saved": "Ziel gespeichert",
  "goal.ledger.title": "Arbeitsprotokoll",
  "goal.ledger.empty": "Noch keine Protokolleinträge.",
  "goal.ledger.supersede": "Ersetzen",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.favorites": "Favoriten",
  "home.inventory.recent": "Aktuell",
  "home.inventory.all": "Alle",
  "home.inventory.favorite": "Zu Favoriten hinzufügen",
  "home.inventory.unfavorite": "Vom Favoriten entfernen",
