export const dict = {
  ...
  "command.session.goal": "Cel i ledger",
  "command.session.goal.description": "Otwórz panel celu sesji i roboczego ledgeru",
  ...
  "goal.objective.title": "Cel główny",
  "goal.objective.placeholder": "Co ta sesja ma osiągnąć?",
  "goal.empty": "Ta sesja nie ma jeszcze ustalonego celu.",
  "goal.setGoal": "Ustaw cel",
  "goal.acceptanceCriteria.title": "Kryteria akceptacji",
  "goal.acceptanceCriteria.empty": "Brak kryteriów akceptacji.",
  "goal.acceptanceCriteria.met": "Spełnione",
  "goal.acceptanceCriteria.waive": "Zrezygnuj",
  "goal.constraints.title": "Ograniczenia",
  "goal.constraints.empty": "Brak ograniczeń.",
  "goal.constraints.fromMessage": "Z wiadomości",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Cel główny nie może być pusty",
  "goal.toast.saved": "Cel zapisany",
  "goal.ledger.title": "Ledger roboczy",
  "goal.ledger.empty": "Brak wpisów w ledgerze.",
  "goal.ledger.supersede": "Zastąp",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Serwery",
  "home.inventory.favorites": "Ulubione",
  "home.inventory.recent": "Ostatnie",
  "home.inventory.all": "Wszystkie",
  "home.inventory.favorite": "Dodaj do ulubionych",
  "home.inventory.unfavorite": "Usuń z ulubionych",
  ...
  "archived.empty": "Brak zarchiwizowanych sesji",
  "trash.title": "Kosz",
  "trash.empty": "Kosz jest pusty",
  "trash.deletePermanently": "Usuń trwale",
  "trash.deleteConfirm.title": "Usunąć trwale?",
  "trash.deleteConfirm.description": "Trwale usuwa „{{title}}” oraz jego transkrypt, zdarzenia, cele, księgę i owned monitor records. Tej operacji nie można cofnąć.",
  "common.key.esc": "ESC",
