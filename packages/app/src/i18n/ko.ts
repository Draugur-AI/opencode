export const dict = {
  ...
  "command.session.goal": "목표 원장",
  "command.session.goal.description": "세션 목표와 작업 원장 패널 열기",
  "goal.objective.title": "목표",
  "goal.objective.placeholder": "이 세션에서 달성하려는 작업은 무엇인가요?",
  "goal.empty": "아직 이 세션에 목표가 설정되지 않았습니다.",
  "goal.setGoal": "목표 설정",
  "goal.acceptanceCriteria.title": "수락 기준",
  "goal.acceptanceCriteria.empty": "아직 수락 기준이 없습니다.",
  "goal.acceptanceCriteria.met": "만족",
  "goal.acceptanceCriteria.waive": "면제",
  "goal.constraints.title": "제약 사항",
  "goal.constraints.empty": "아직 제약 사항이 없습니다.",
  "goal.constraints.fromMessage": "메시지에서",
  "goal.status.title": "상태",
  "goal.toast.objectiveRequired": "목표는 빈 상태로 둘 수 없습니다",
  "goal.toast.saved": "목표 저장됨",
  "goal.ledger.title": "작업 원장",
  "goal.ledger.empty": "아직 원장 항목이 없습니다.",
  "goal.ledger.supersede": "업데이트",
  "session.tab.goal": "목표",
  "common.add": "추가",
  ...
  "home.inventory.servers": "서버",
  "home.inventory.favorites": "즐겨찾기",
  "home.inventory.recent": "최근",
  "home.inventory.all": "전체",
  "home.inventory.favorite": "즐겨찾기에 추가",
  "home.inventory.unfavorite": "즐겨찾기에서 제거",
