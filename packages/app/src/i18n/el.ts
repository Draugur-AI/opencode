export const dict = {
  ...
  "command.session.goal": "Στόχος & μητρώο",
  "command.session.goal.description": "Άνοιγμα του πίνακα στόχου και εργασίας της συνεδρίας",
  "goal.objective.title": "Αντικειμενικός σκοπός",
  "goal.objective.placeholder": "Τι προσπαθεί να πετύχει αυτή η συνεδρία;",
  "goal.empty": "Δεν έχει οριστεί στόχος για αυτή τη συνεδρία ακόμα.",
  "goal.setGoal": "Ορισμός στόχου",
  "goal.acceptanceCriteria.title": "Κριτήρια αποδοχής",
  "goal.acceptanceCriteria.empty": "Δεν υπάρχουν ακόμη κριτήρια αποδοχής.",
  "goal.acceptanceCriteria.met": "Ικανοποιήθηκε",
  "goal.acceptanceCriteria.waive": "Απάλλαξη",
  "goal.constraints.title": "Περιορισμοί",
  "goal.constraints.empty": "Δεν υπάρχουν ακόμη περιορισμοί.",
  "goal.constraints.fromMessage": "Από μήνυμα",
  "goal.status.title": "Κατάσταση",
  "goal.toast.objectiveRequired": "Ο αντικειμενικός σκοπός δεν μπορεί να είναι κενός",
  "goal.toast.saved": "Ο στόχος αποθηκεύτηκε",
  "goal.ledger.title": "Εργαλείο μητρώου",
  "goal.ledger.empty": "Δεν υπάρχουν ακόμη εγγραφές μητρώου.",
  "goal.ledger.supersede": "Αντικατάσταση",
  "language.en": "Αγγλικά",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "archived.title": "Αρχειοθετημένα",
  "archived.empty": "Δεν υπάρχουν αρχειοθετημένες συνεδρίες",
  "trash.title": "Καλάθι",
  "trash.empty": "Καλάθι άδειο",
  "trash.deletePermanently": "Οριστική διαγραφή",
  "trash.deleteConfirm.title": "Οριστική διαγραφή;",
  "trash.deleteConfirm.description": "Με αυτή τη λειτουργία διαγράφεται οριστικά το \"{{title}}\" και η μεταγραφή, τα γεγονότα, οι στόχοι, το μητρώο και τα αρχεία παρακολούθησης που κατέχει. Δεν μπορεί να ανακληθεί.",
