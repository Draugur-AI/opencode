export const dict = {
  ...
  "command.session.goal": "Objetivo y registro",
  "command.session.goal.description": "Abrir el panel de objetivo de sesión y registro de trabajo",
  ...
  "goal.objective.placeholder": "¿Qué pretende lograr esta sesión?",
  "goal.empty": "Aún no hay un objetivo establecido para esta sesión.",
  "goal.setGoal": "Establecer objetivo",
  "goal.acceptanceCriteria.title": "Criterios de aceptación",
  "goal.acceptanceCriteria.empty": "Aún no hay criterios de aceptación.",
  "goal.acceptanceCriteria.met": "Cumplido",
  "goal.acceptanceCriteria.waive": "Excluir",
  "goal.constraints.title": "Restricciones",
  "goal.constraints.empty": "Aún no hay restricciones.",
  "goal.constraints.fromMessage": "Desde mensaje",
  "goal.status.title": "Estado",
  "goal.toast.objectiveRequired": "El objetivo no puede estar vacío",
  "goal.toast.saved": "Objetivo guardado",
  "goal.ledger.title": "Registro de trabajo",
  "goal.ledger.empty": "Aún no hay entradas en el registro.",
  "goal.ledger.supersede": "Reemplazar",
  ...
  "home.inventory.recent": "Recientes",
  "home.inventory.all": "Todo",
  "home.inventory.favorite": "Añadir a favoritos",
  "home.inventory.unfavorite": "Quitar de favoritos",
