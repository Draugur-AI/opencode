export const dict = {
  ...
  "home.inventory.servers": "الخوادم",
  "home.inventory.favorites": "المفضلة",
  "home.inventory.recent": "الحديثة",
  "home.inventory.all": "الكل",
  "home.inventory.favorite": "إضافة إلى المفضلة",
  "home.inventory.unfavorite": "إزالة من المفضلة",
  "home.providerTip": "اتصل بأكثر من 75 موفرًا لاستخدام نماذج أخرى، بما فيها Claude وGPT وGemini وغيرها",
  "archived.title": "الأرشيف",
  "archived.empty": "لا توجد جلسات مؤرشفة",
  "trash.title": "سلة المحذوفات",
  "trash.empty": "سلة المحذوفات فارغة",
  "trash.deletePermanently": "حذف نهائيًا",
  "trash.deleteConfirm.title": "حذف نهائيًا؟",
  "trash.deleteConfirm.description": "سيتم حذف \"{{title}}\" ورسائلها وبياناتها وسجل الأحداث والأهداف ودليل العمليات وتسجلات المراقبة الخاصة بها نهائيًا. لا يمكن التراجع عن هذا الإجراء.",
  ...
  "command.session.goal": "الهدف والسجل",
  "command.session.goal.description": "فتح لوحة هدف الجلسة والسجل التشغيلي",
  "goal.objective.title": "الهدف",
  "goal.objective.placeholder": "ماذا تحاول هذه الجلسة إنجازه؟",
  "goal.empty": "لم يُحدد هدف لهذه الجلسة بعد.",
  "goal.setGoal": "تحديد هدف",
  "goal.acceptanceCriteria.title": "معايير القبول",
  "goal.acceptanceCriteria.empty": "لا توجد معايير قبول بعد.",
  "goal.acceptanceCriteria.met": "مُستوفى",
  "goal.acceptanceCriteria.waive": "تجاوز",
  "goal.constraints.title": "القيود",
  "goal.constraints.empty": "لا توجد قيود بعد.",
  "goal.constraints.fromMessage": "من الرسالة",
  "goal.status.title": "الحالة",
  "goal.toast.objectiveRequired": "لا يمكن أن يكون الهدف فارغًا",
  "goal.toast.saved": "تم حفظ الهدف",
  "goal.ledger.title": "السجل التشغيلي",
  "goal.ledger.empty": "لا توجد إدخالات في السجل بعد.",
  "goal.ledger.supersede": "استبدال",
  "session.tab.goal": "الهدف",
  "common.add": "إضافة",
