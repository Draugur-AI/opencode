export const dict = {
  ...
  "command.session.goal": "Objetivo e bloco de notas",
  "command.session.goal.description": "Abrir o painel de objetivo e bloco de notas da sessão",
  ...
  "goal.objective.title": "Objetivo",
  "goal.objective.placeholder": "O que esta sessão tenta realizar?",
  "goal.empty": "Nenhum objetivo definido para esta sessão ainda.",
  "goal.setGoal": "Definir objetivo",
  "goal.acceptanceCriteria.title": "Critérios de aceitação",
  "goal.acceptanceCriteria.empty": "Nenhum critério de aceitação ainda.",
  "goal.acceptanceCriteria.met": "Atendido",
  "goal.acceptanceCriteria.waive": "Isentar",
  "goal.constraints.title": "Restrições",
  "goal.constraints.empty": "Nenhuma restrição ainda.",
  "goal.constraints.fromMessage": "Da mensagem",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "O objetivo não pode estar vazio",
  "goal.toast.saved": "Objetivo salvo",
  "goal.ledger.title": "Bloco de notas",
  "goal.ledger.empty": "Nenhuma entrada no bloco de notas ainda.",
  "goal.ledger.supersede": "Substituir",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "archived.empty": "Nenhuma sessão arquivada",
  "trash.title": "Lixeira",
  "trash.empty": "A lixeira está vazia",
  "trash.deletePermanently": "Excluir permanentemente",
  "trash.deleteConfirm.title": "Excluir permanentemente?",
  "trash.deleteConfirm.description": "Essa ação excluirá permanentemente \"{{title}}\" e seu transcript, eventos, objetivos, ledger e registros de monitor de propriedade. Essa ação não pode ser desfeita.",
  ...
  "home.inventory.servers": "Servidores",
  "home.inventory.favorites": "Favoritos",
  "home.inventory.recent": "Recentes",
  "home.inventory.all": "Todos",
  "home.inventory.favorite": "Adicionar aos favoritos",
  "home.inventory.unfavorite": "Remover dos favoritos",
