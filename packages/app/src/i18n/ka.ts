export const dict = {
  ...
  "command.session.goal": "მიზანი და ლეჯერი",
  "command.session.goal.description": "აჩვენე სესიის მიზნისა და სამუშაო ლეჯერის პანელი",
  ...
  "goal.objective.title": "ნაბიჯი",
  "goal.objective.placeholder": "რა მივაღწიოთ ამ სესიით?",
  "goal.empty": "ამ სესიისთვის მიზანი ჯერ დაყენებული არ არის.",
  "goal.setGoal": "მიზნის დაყენება",
  "goal.acceptanceCriteria.title": "მიღების კრიტერიუმები",
  "goal.acceptanceCriteria.empty": "მიღების კრიტერიუმები ჯერ დაყენებული არ არის.",
  "goal.acceptanceCriteria.met": "დაკმაყოფილებულია",
  "goal.acceptanceCriteria.waive": "გაუქმება",
  "goal.constraints.title": "შეზღუდვები",
  "goal.constraints.empty": "შეზღუდვები ჯერ დაყენებული არ არის.",
  "goal.constraints.fromMessage": "შეტყობინებიდან",
  "goal.status.title": "სტატუსი",
  "goal.toast.objectiveRequired": "ნაბიჯი ცარიელი ვერ იქნება",
  "goal.toast.saved": "მიზანი შენახულია",
  "goal.ledger.title": "სამუშაო ლეჯერი",
  "goal.ledger.empty": "ლეჯერის ჩანაწერები ჯერ დაგროვებული არ არის.",
  "goal.ledger.supersede": "ჩანაცვლება",
  ...
  "home.inventory.servers": "სერვერები",
  "home.inventory.favorites": "ფავორიტები",
  "home.inventory.recent": "ბოლო",
  "home.inventory.all": "ყველა",
  "home.inventory.favorite": "დამატება ფავორიტებში",
  "home.inventory.unfavorite": "წაშლა ფავორიტებიდან",
  ...
  "archived.title": "არქივი",
  "archived.empty": "არქივირებული სესიები არ არის",
  "trash.title": "კალათა",
  "trash.empty": "კალათა ცარიელია",
  "trash.deletePermanently": "სამუდამოდ წაშლა",
  "trash.deleteConfirm.title": "სამუდამოდ წაიშალოს?",
  "trash.deleteConfirm.description": "ეს სამუდამოდ წაშლის \"{{title}}\"-ს და მის ტრანსკრიფტს, მოვლენებს, მიზნებს, ლეჯერს და ფლობის მონიტორინგის ჩანაწერებს. ეს ვერ გაუქმდება.",
  "session.tab.session": "სესია",
  "session.tab.review": "მიმოხილვა",
  "session.tab.context": "კონტექსტი",
  "session.tab.goal": "მიზანი",
