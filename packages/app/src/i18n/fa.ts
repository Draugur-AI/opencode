export const dict = {
  ...
  "command.session.goal": "هدف و دفتر کار",
  "command.session.goal.description": "باز کردن پنل هدف جلسه و دفتر کار",
  ...
  "goal.objective.title": "هدف کلان",
  "goal.objective.placeholder": "این جلسه می‌خواهد به چه چیزی برسد؟",
  "goal.empty": "هنوز هدفی برای این جلسه تعیین نشده است.",
  "goal.setGoal": "تعیین هدف",
  "goal.acceptanceCriteria.title": "معیارهای پذیرش",
  "goal.acceptanceCriteria.empty": "هنوز معیار پذیرشی تعیین نشده است.",
  "goal.acceptanceCriteria.met": "تحقق یافته",
  "goal.acceptanceCriteria.waive": "صرف‌نظر",
  "goal.constraints.title": "محدودیت‌ها",
  "goal.constraints.empty": "هنوز محدودیتی تعیین نشده است.",
  "goal.constraints.fromMessage": "از پیام",
  "goal.status.title": "وضعیت",
  "goal.toast.objectiveRequired": "هدف کلان نمی‌تواند خالی باشد",
  "goal.toast.saved": "هدف ذخیره شد",
  "goal.ledger.title": "دفتر کار",
  "goal.ledger.empty": "هنوز ورودی دفتری ثبت نشده است.",
  "goal.ledger.supersede": "جایگزین کردن",
  "session.tab.goal": "هدف",
  "language.en": "انگلیسی",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "سرورها",
  "home.inventory.favorites": "علاقه‌مندی‌ها",
  "home.inventory.recent": "اخیر",
  "home.inventory.all": "همه",
  "home.inventory.favorite": "افزودن به علاقه‌مندی‌ها",
  "home.inventory.unfavorite": "حذف از علاقه‌مندی‌ها",
  ...
  "archived.title": "بایگانی‌شده‌ها",
  "archived.empty": "هیچ جلسه بایگانی‌شده‌ای وجود ندارد",
  "trash.title": "سطل زباله",
  "trash.empty": "سطل زباله خالی است",
  "trash.deletePermanently": "حذف دائمی",
  "trash.deleteConfirm.title": "حذف دائمی؟",
  "trash.deleteConfirm.description": "این عمل «{{title}}» و تاریخچه، رویدادها، اهداف، دفترچه نظارت و رکوردهای متعلق به آن را به‌صورت دائمی حذف می‌کند. این عمل قابل بازگشت نیست.",
