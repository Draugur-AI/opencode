...
export const dict = {
  ...
  "command.session.goal": "Goal & ledger",
  "command.session.goal.description": "Open the session goal and working ledger panel",
  ...
  "goal.objective.title": "Objective",
  "goal.objective.placeholder": "What is this session trying to accomplish?",
  "goal.empty": "No goal set for this session yet.",
  "goal.setGoal": "Set goal",
  "goal.acceptanceCriteria.title": "Acceptance criteria",
  "goal.acceptanceCriteria.empty": "No acceptance criteria yet.",
  "goal.acceptanceCriteria.met": "Met",
  "goal.acceptanceCriteria.waive": "Waive",
  "goal.constraints.title": "Constraints",
  "goal.constraints.empty": "No constraints yet.",
  "goal.constraints.fromMessage": "From message",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "The objective cannot be empty",
  "goal.toast.saved": "Goal saved",
  "goal.ledger.title": "Working ledger",
  "goal.ledger.empty": "No ledger entries yet.",
  "goal.ledger.supersede": "Supersede",
  ...
  "home.inventory.favorites": "Favorites",
  "home.inventory.recent": "Recent",
  "home.inventory.all": "All",
  "home.inventory.favorite": "Add to favorites",
  "home.inventory.unfavorite": "Remove from favorites",
  ...
  "settings.mcp.dialog.cwd": "Working directory",
  "settings.mcp.dialog.url": "URL",
  "settings.mcp.dialog.disabled": "Disabled",
  "settings.mcp.dialog.environment": "Environment variables",
  "settings.mcp.dialog.headers": "Headers",
  "settings.mcp.dialog.credentialKey": "Name",
  "settings.mcp.dialog.credentialValue": "Value",
