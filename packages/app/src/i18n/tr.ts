...
export const dict = {
  ...
  "command.session.goal": "Hedef ve defter",
  "command.session.goal.description": "Oturum hedefi ve çalışma defteri panelini aç",
  ...
  "goal.objective.title": "Hedef",
  "goal.objective.placeholder": "Bu oturum neyi başarmayı amaçlıyor?",
  "goal.empty": "Bu oturum için henüz bir hedef belirlenmedi.",
  "goal.setGoal": "Hedef belirle",
  "goal.acceptanceCriteria.title": "Kabul kriterleri",
  "goal.acceptanceCriteria.empty": "Henüz kabul kriteri yok.",
  "goal.acceptanceCriteria.met": "Karşılandı",
  "goal.acceptanceCriteria.waive": "Geldi",
  "goal.constraints.title": "Kısıtlamalar",
  "goal.constraints.empty": "Henüz kısıtlama yok.",
  "goal.constraints.fromMessage": "Mesajdan",
  "goal.status.title": "Durum",
  "goal.toast.objectiveRequired": "Hedef boş olamaz",
  "goal.toast.saved": "Hedef kaydedildi",
  "goal.ledger.title": "Çalışma defteri",
  "goal.ledger.empty": "Henüz defter girişi yok.",
  "goal.ledger.supersede": "Supersede",
  "session.tab.goal": "Hedef",
  "common.add": "Ekle",
  ...
  "home.inventory.servers": "Sunucular",
  "home.inventory.favorites": "Favoriler",
  "home.inventory.recent": "Son",
  "home.inventory.all": "Tümü",
  "home.inventory.favorite": "Favorilere ekle",
  "home.inventory.unfavorite": "Favorilerden kaldır",
