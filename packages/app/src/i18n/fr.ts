export const dict = {
  ...
  "command.session.goal": "Objectif et registre",
  "command.session.goal.description": "Ouvrir le panneau de l'objectif de session et du registre de travail",
  ...
  "goal.objective.title": "Objectif",
  "goal.objective.placeholder": "Que cherche à accomplir cette session ?",
  "goal.empty": "Aucun objectif défini pour cette session.",
  "goal.setGoal": "Définir un objectif",
  "goal.acceptanceCriteria.title": "Critères d'acceptation",
  "goal.acceptanceCriteria.empty": "Aucun critère d'acceptation.",
  "goal.acceptanceCriteria.met": "Atteint",
  "goal.acceptanceCriteria.waive": "Dispenser",
  "goal.constraints.title": "Contraintes",
  "goal.constraints.empty": "Aucune contrainte.",
  "goal.constraints.fromMessage": "Depuis le message",
  "goal.status.title": "Statut",
  "goal.toast.objectiveRequired": "L'objectif ne peut pas être vide",
  "goal.toast.saved": "Objectif enregistré",
  "goal.ledger.title": "Registre de travail",
  "goal.ledger.empty": "Aucune entrée dans le registre.",
  "goal.ledger.supersede": "Substituer",
  "session.tab.goal": "Objectif",
  "common.add": "Ajouter",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  ...
  "home.inventory.servers": "Serveurs",
  "home.inventory.favorites": "Favoris",
  "home.inventory.recent": "Récent",
  "home.inventory.all": "Tout",
  "home.inventory.favorite": "Ajouter aux favoris",
  "home.inventory.unfavorite": "Retirer des favoris",
  ...
  "archived.empty": "Aucune session archivée",
  "trash.title": "Corbeille",
  "trash.empty": "La corbeille est vide",
  "trash.deletePermanently": "Supprimer définitivement",
  "trash.deleteConfirm.title": "Supprimer définitivement ?",
  "trash.deleteConfirm.description": "Cette action supprime définitivement « {{title}} » ainsi que sa transcription, ses événements, ses objectifs, son registre et les enregistrements de suivi qu'il possède. Cette action est irréversible.",
