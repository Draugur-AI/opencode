export const dict = {
  ...
  "command.session.goal": "Matlamat & buku besar",
  "command.session.goal.description": "Buka panel matlamat dan buku besar operasi sesi",
  ...
  "goal.objective.title": "Objektif",
  "goal.objective.placeholder": "Apa yang cuba dicapai oleh sesi ini?",
  "goal.empty": "Tiada matlamat ditetapkan untuk sesi ini lagi.",
  "goal.setGoal": "Tetapkan matlamat",
  "goal.acceptanceCriteria.title": "Kriteria penerimaan",
  "goal.acceptanceCriteria.empty": "Tiada kriteria penerimaan lagi.",
  "goal.acceptanceCriteria.met": "Dipenuhi",
  "goal.acceptanceCriteria.waive": "Lepaskan",
  "goal.constraints.title": "Perbatasan",
  "goal.constraints.empty": "Tiada perbatasan lagi.",
  "goal.constraints.fromMessage": "Dari mesej",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Objektif tidak boleh kosong",
  "goal.toast.saved": "Matlamat disimpan",
  "goal.ledger.title": "Buku besar operasi",
  "goal.ledger.empty": "Tiada entri buku besar lagi.",
  "goal.ledger.supersede": "Gantikan",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Pelayan",
  "home.inventory.favorites": "Kegemaran",
  "home.inventory.recent": "Terbaru",
  "home.inventory.all": "Semua",
  "home.inventory.favorite": "Tambah ke kesukaan",
  "home.inventory.unfavorite": "Buang dari kesukaan",
  ...
  "archived.title": "Dipertahan",
  "archived.empty": "Tiada sesi bertahan",
  "trash.title": "Tong sampah",
  "trash.empty": "Tong sampah kosong",
  "trash.deletePermanently": "Padam kekal",
  "trash.deleteConfirm.title": "Padam kekal?",
  "trash.deleteConfirm.description": "Ini akan memadam \"{{title}}\" dan transkrip, kejadian, matlamat, buku besar, dan rakaman monitor miliknya secara kekal. Tindakan ini tidak boleh dibatalkan.",
  "session.tab.session": "Sesi",
  "session.tab.review": "Semak",
  "session.tab.context": "Konteks",
  "session.tab.goal": "Matlamat",
