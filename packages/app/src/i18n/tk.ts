export const dict = {
  ...
  "command.session.goal": "Maksat we hasabat",
  "command.session.goal.description": "Sessiýa maksadyny we işleme hasabat panelini açyň",
  ...
  "goal.objective.title": "Maksat",
  "goal.objective.placeholder": 'Bu sessiýa näme gazanmagy meýilleşdirýär?',
  "goal.empty": "Bu sessiýa üçin heniz maksat bellenmedik.",
  "goal.setGoal": "Maksat belle",
  "goal.acceptanceCriteria.title": "Kabul etme şertleri",
  "goal.acceptanceCriteria.empty": "Kabul etme şertleri heniz ýok.",
  "goal.acceptanceCriteria.met": "Kabul edildi",
  "goal.acceptanceCriteria.waive": "Waiver",
  "goal.constraints.title": "Çäklendirmeler",
  "goal.constraints.empty": "Çäklendirmeler heniz ýok.",
  "goal.constraints.fromMessage": "Habardan",
  "goal.status.title": "Ýagdaýy",
  "goal.toast.objectiveRequired": "Maksat boş bolup bilmez",
  "goal.toast.saved": "Maksat saklandy",
  "goal.ledger.title": "Işleme hasabaty",
  "goal.ledger.empty": "Hasabat ýazgylary heniz ýok.",
  "goal.ledger.supersede": "Üstesine çyk",
  "language.en": "Iňlis",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Serwerler",
  "home.inventory.favorites": "Sahalananlar",
  "home.inventory.recent": "Soňky",
  "home.inventory.all": "Ählisi",
  "home.inventory.favorite": "Sahalananlara goş",
  "home.inventory.unfavorite": "Sahalananlardan aýyr",
  ...
  "common.delete": "Poz",
  "common.close": ".Akyn",
  "common.restore": "Dikelt",
  "archived.title": "Arhiwlenenler",
  "archived.empty": "Arhiwlenen sessiýa ýok",
  "trash.title": "Gowga",
  "trash.empty": "Gowga boş",
  "trash.deletePermanently": "Hemişelik poz",
  "trash.deleteConfirm.title": "Hemişelik pozulmalymy?",
  "trash.deleteConfirm.description": '"{{title}}" we onuň ýazgysy, wakalar, maksatlar, hasabat we eýe bolan gözegçilik ýazgylary hemişelik pozular. Muny yza gaýtaryp bolmaýar.',
