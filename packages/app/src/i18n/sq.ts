export const dict = {
  ...
  "command.session.goal": "Qëllimi dhe ledri",
  "command.session.goal.description": "Hap panelin e qëllimit të sesionit dhe ledrit të punës",
  ...
  "goal.objective.title": "Objektivi",
  "goal.objective.placeholder": "Çfarë po përpiqet të arrijë ky sesion?",
  "goal.empty": "Nuk ka qëllim të caktuar ende për këtë sesion.",
  "goal.setGoal": "Cakto qëllimin",
  "goal.acceptanceCriteria.title": "Kriteret e pranimit",
  "goal.acceptanceCriteria.empty": "Ende nuk ka kritere pranimi.",
  "goal.acceptanceCriteria.met": "I plotësuar",
  "goal.acceptanceCriteria.waive": "Heq dorë",
  "goal.constraints.title": "Kushtet",
  "goal.constraints.empty": "Ende nuk ka kufizime.",
  "goal.constraints.fromMessage": "Nga mesazhi",
  "goal.status.title": "Statusi",
  "goal.toast.objectiveRequired": "Objektivi nuk mund të jetë bosh",
  "goal.toast.saved": "Qëllimi u ruajt",
  "goal.ledger.title": "Ledri i punës",
  "goal.ledger.empty": "Ende nuk ka hyrje në ledër.",
  "goal.ledger.supersede": "Zëvendëso",
  ...
  "home.inventory.servers": "Serverat",
  "home.inventory.favorites": "Dëshirat",
  "home.inventory.recent": "I fundit",
  "home.inventory.all": "Të gjitha",
  "home.inventory.favorite": "Shto te dëshirat",
  "home.inventory.unfavorite": "Hiq nga dëshirat",
