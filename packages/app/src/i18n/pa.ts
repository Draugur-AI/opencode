export const dict = {
  ...
  "command.session.goal": "ہدف تے لیجر",
  "command.session.goal.description": "سیشن ہدف تے ورکنگ لیجر پینل کھولو",
  ...
  "goal.objective.placeholder": "ایس سیشن ناں کی کرنے دا ہے؟",
  "goal.empty": "اس سیشن لئی کوئی ہدف نئیں سیٹ کیتا گیا۔",
  "goal.setGoal": "ہدف سیٹ کرو",
  "goal.acceptanceCriteria.title": "قبولیّت دے معیارات",
  "goal.acceptanceCriteria.empty": "ہلے کوئی قبولیت دے معیارات نئیں۔",
  "goal.acceptanceCriteria.met": "پورا ہویا",
  "goal.acceptanceCriteria.waive": "معاف",
  "goal.constraints.title": "قیداں",
  "goal.constraints.empty": "ہلے کوئی قید نئیں۔",
  "goal.constraints.fromMessage": "سنیہے توں",
  "goal.status.title": "حیثیت",
  "goal.toast.objectiveRequired": "مقصد خالی نہ ہو سگدا",
  "goal.toast.saved": "ہدف محفوظ",
  "goal.ledger.title": "ورکنگ لیجر",
  "goal.ledger.empty": "ہلے کوئی لیجر انڑریاں نئیں۔",
  "goal.ledger.supersede": "سپرسیڈ",
  "session.tab.goal": "ہدف",
  "common.add": "شامل کرو",
  "language.en": "انگریجی",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  ...
  "home.inventory.servers": "سرور",
  "home.inventory.favorites": "پسندیدہ",
  "home.inventory.recent": "حالے",
  "home.inventory.all": "سب",
  "home.inventory.favorite": "پسندیدیاں وچ شامل کرو",
  "home.inventory.unfavorite": "پسندیدیاں توں ہٹاؤ",
  ...
  "archived.empty": "کوئی آرکائیو شدہ سیشن نئیں",
  "trash.title": "کوڑا خانہ",
  "trash.empty": "کوڑا خانہ خالی اے",
  "trash.deletePermanently": "ہمیشہ لئی مٹاؤ",
  "trash.deleteConfirm.title": "ہمیشہ لئی مٹایا جائے؟",
  "trash.deleteConfirm.description": "ایہ \"{{title}}\" تے ایندا ٹرانسکرپٹ، ایونٹس، اہداف، لیجر، تے مالک مانیٹر ریکارڈ ہمیشہ لئی مٹا دیندا اے۔ ایہنوں واپس نئیں لایا جا سکدا۔",
