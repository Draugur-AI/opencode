export const dict = {
  ...
  "command.session.goal": "Məqsəd və dəftər",
  "command.session.goal.description": "Sessiya məqsədi və iş dəftəri panelini aç",
  ...
  "goal.objective.title": "Məqsəd",
  "goal.objective.placeholder": "Bu sessiyanın hədəfi nədir?",
  "goal.empty": "Bu sessiya üçün hələ məqsəd təyin edilməyib.",
  "goal.setGoal": "Məqsəd təyin et",
  "goal.acceptanceCriteria.title": "Qəbul meyarları",
  "goal.acceptanceCriteria.empty": "Hələ qəbul meyarı yoxdur.",
  "goal.acceptanceCriteria.met": "Yararılan",
  "goal.acceptanceCriteria.waive": "Ləğv et",
  "goal.constraints.title": "Məhdudiyyətlər",
  "goal.constraints.empty": "Hələ məhdudiyyət yoxdur.",
  "goal.constraints.fromMessage": "Mesajdan",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Məqsəd boş ola bilməz",
  "goal.toast.saved": "Məqsəd saxlanıldı",
  "goal.ledger.title": "İş dəftəri",
  "goal.ledger.empty": "Hələ dəftər yazısı yoxdur.",
  "goal.ledger.supersede": "Əvəzlə",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Serverlər",
  "home.inventory.favorites": "Sevimlilər",
  "home.inventory.recent": "Son baxılanlar",
  "home.inventory.all": "Hamısı",
  "home.inventory.favorite": "Sevimlilərə əlavə et",
  "home.inventory.unfavorite": "Sevimlilərdən sil",
