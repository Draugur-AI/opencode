...
export const dict = {
  ...
  "command.session.goal": "Tikslas ir žurnalas",
  "command.session.goal.description": "Atidaryti seanso tikslo ir darbo žurnalo skydelį",
  ...
  "goal.objective.title": "Tikslas",
  "goal.objective.placeholder": "Ko siekia šis seansas?",
  "goal.empty": "Šiam seansui tikslas dar nepapasakyta.",
  "goal.setGoal": "Nustatyti tikslą",
  "goal.acceptanceCriteria.title": "Priėmimo kriterijai",
  "goal.acceptanceCriteria.empty": "Priėmimo kriterijų dar nėra.",
  "goal.acceptanceCriteria.met": "Įvykdyta",
  "goal.acceptanceCriteria.waive": "Atšaukti",
  "goal.constraints.title": "Apribojimai",
  "goal.constraints.empty": "Apribojimų dar nėra.",
  "goal.constraints.fromMessage": "Iš žinutės",
  "goal.status.title": "Būsena",
  "goal.toast.objectiveRequired": "Tikslas negali būti tuščias",
  "goal.toast.saved": "Tikslas išsaugotas",
  "goal.ledger.title": "Darbo žurnalas",
  "goal.ledger.empty": "Žurnalo įrašų dar nėra.",
  "goal.ledger.supersede": "Naujesnis",
  ...
  "home.inventory.servers": "Serveriai",
  "home.inventory.favorites": "Mėgstamiausi",
  "home.inventory.recent": "Naujausi",
  "home.inventory.all": "Visi",
  "home.inventory.favorite": "Pridėti prie mėgstamiausių",
  "home.inventory.unfavorite": "Pašalinti iš mėgstamiausių",
  ...
  "archived.title": "Archyvas",
  "archived.empty": "Nėra archyvuotų seansų",
  "trash.title": "Šiukšliadėžė",
  "trash.empty": "Šiukšliadėžė tuščia",
  "trash.deletePermanently": "Ištrinti visam",
  "trash.deleteConfirm.title": "Ištrinti visam?",
  "trash.deleteConfirm.description": "Tai visam ištrins „{{title}}“ ir jos stenogramą, įvykius, tikslus, sąvadą bei valdomus monitoriaus įrašus. To atšaukti negalima.",
  "session.tab.session": "Seansas",
  "session.tab.review": "Apžvalga",
  "session.tab.context": "Kontekstas",
  "session.tab.goal": "Tikslas",
