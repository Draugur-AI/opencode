export const dict = {
  ...
  "command.session.goal.description": "Åbn panel til sessionsmål og arbejdsledger",
  ...
  "goal.objective.placeholder": "Hvad skal denne session opnå?",
  "goal.empty": "Intet mål er defineret for denne session endnu.",
  "goal.setGoal": "Indstil mål",
  "goal.acceptanceCriteria.title": "Acceptkriterier",
  "goal.acceptanceCriteria.empty": "Ingen acceptkriterier endnu.",
  "goal.acceptanceCriteria.met": "Opfyldt",
  "goal.acceptanceCriteria.waive": "Fravig",
  "goal.constraints.title": "Begrænsninger",
  "goal.constraints.empty": "Ingen begrænsninger endnu.",
  "goal.constraints.fromMessage": "Fra besked",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Målet må ikke være tomt",
  "goal.toast.saved": "Mål gemt",
  "goal.ledger.title": "Working ledger",
  "goal.ledger.empty": "Ingen ledger-poster endnu.",
  "goal.ledger.supersede": "Forbigå",
  ...
  "home.inventory.recent": "Seneste",
  "home.inventory.all": "Alle",
  "home.inventory.favorite": "Tilføj til favoritter",
  ...
  "common.close": "Luk",
  "archived.title": "Arkiverede",
  "archived.empty": "Ingen arkiverede sessioner",
  "trash.title": "Papirkurv",
  "trash.empty": "Papirkurven er tom",
  "trash.deletePermanently": "Slet permanent",
  "trash.deleteConfirm.title": "Slet permanent?",
  "trash.deleteConfirm.description": "Dette sletter permanent \"{{title}}\" og dennes transcript, events, goals, ledger og egede monitor poster. Dette kan ikke fortrydes.",
  "common.edit": "Rediger",
  "common.add": "Tilføj",
