export const dict = {
  ...
  "home.inventory.servers": "Palvelimet",
  "home.inventory.favorites": "Suosikit",
  "home.inventory.recent": "Viimeiset",
  "home.inventory.all": "Kaikki",
  "home.inventory.favorite": "Lisää suosikkeihin",
  "home.inventory.unfavorite": "Poista suosikeista",
  ...
  "archived.title": "Arkistoidut",
  "archived.empty": "Ei arkistoituja istuntoja",
  "trash.title": "Roskakori",
  "trash.empty": "Roskakori on tyhjä",
  "trash.deletePermanently": "Poista pysyvästi",
  "trash.deleteConfirm.title": "Poistetaanko pysyvästi?",
  "trash.deleteConfirm.description": "Tämä poistaa pysyvästi kohteen \"{{title}}\" sekä sen transkriptiot, tapahtumat, tavoitteet, tunnusluvut ja omat monitorointitietueet. Tätä ei voi peruuttaa.",
  "session.tab.session": "Istunto",
  "session.tab.review": "Tarkistus",
  "session.tab.context": "Konteksti",
  "session.tab.goal": "Tavoite",
