export const dict = {
  ...
  "command.session.goal": "Cíl a účetní kniha",
  "command.session.goal.description": "Otevřít panel cíle relace a pracovní účetní knihy",
  ...
  "goal.objective.title": "Cíl",
  "goal.objective.placeholder": "Čeho se má tato relace dosáhnout?",
  "goal.empty": "Pro tuto relaci zatím není stanoven cíl.",
  "goal.setGoal": "Nastavit cíl",
  "goal.acceptanceCriteria.title": "Kritéria přijetí",
  "goal.acceptanceCriteria.empty": "Zatím žádná kritéria přijetí.",
  "goal.acceptanceCriteria.met": "Splněno",
  "goal.acceptanceCriteria.waive": "Upustit",
  "goal.constraints.title": "Omezení",
  "goal.constraints.empty": "Zatím žádná omezení.",
  "goal.constraints.fromMessage": "Ze zprávy",
  "goal.status.title": "Stav",
  "goal.toast.objectiveRequired": "Cíl nemůže být prázdný",
  "goal.toast.saved": "Cíl uložen",
  "goal.ledger.title": "Pracovní účetní kniha",
  "goal.ledger.empty": "Zatím žádné položky v účetní knize.",
  "goal.ledger.supersede": "Nahradit",
  ...
  "archived.empty": "Žádné archivované relace",
  "trash.title": "Koš",
  "trash.empty": "Koš je prázdný",
  "trash.deletePermanently": "Odstranit trvale",
  "trash.deleteConfirm.title": "Odstranit trvale?",
  "trash.deleteConfirm.description": "Tímto trvale odstraníte „{{title}}“ a její přepis, události, cíle, ledger a vlastní monitor záznamy. Toto nelze vzít zpět.",
  "session.tab.session": "Relace",
  "session.tab.review": "Recenze",
  "session.tab.context": "Kontext",
  "session.tab.goal": "Cíl",
