export const dict = {
  ...
  "command.session.goal": "مقصد اور لیجر",
  "command.session.goal.description": "سیشن کے مقصد اور ورکنگ لیجر پینل کو کھولیں",
  ...
  "goal.objective.title": "مقصد",
  "goal.objective.placeholder": "یہ سیشن کیا حاصل کرنا چاہتا ہے؟",
  "goal.empty": "اس سیشن کا کوئی مقصد ابھی تک سیٹ نہیں کیا گیا ہے۔",
  "goal.setGoal": "مقصد مقرر کریں",
  "goal.acceptanceCriteria.title": "مقبولیت کے معیارات",
  "goal.acceptanceCriteria.empty": "ابھی تک کوئی مقبولیت کے معیارات نہیں ہیں۔",
  "goal.acceptanceCriteria.met": "مکمل",
  "goal.acceptanceCriteria.waive": "معاف",
  "goal.constraints.title": "پابندیاں",
  "goal.constraints.empty": "ابھی تک کوئی پابندیاں نہیں ہیں۔",
  "goal.constraints.fromMessage": "پیغام سے",
  "goal.status.title": "حیثیت",
  "goal.toast.objectiveRequired": "مقصد خالی نہیں ہو سکتا",
  "goal.toast.saved": "مقصد محفوظ ہو گیا",
  "goal.ledger.title": "ورکنگ لیجر",
  "goal.ledger.empty": "ابھی تک کوئی لیجر اندراجات نہیں ہیں۔",
  "goal.ledger.supersede": "سپرسیڈ",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "سرورز",
  "home.inventory.favorites": "پسندیدہ",
  "home.inventory.recent": "حالیہ",
  "home.inventory.all": "سب",
  "home.inventory.favorite": "پسندیدہ میں شامل کریں",
  "home.inventory.unfavorite": "پسندیدہ سے ہٹائیں",
  ...
  "archived.title": "آرکائیو شدہ",
  "archived.empty": "کوئی آرکائیو شدہ سیشن نہیں ہے",
  "trash.title": "کوڑا دان",
  "trash.empty": "کوڑا دان خالی ہے",
  "trash.deletePermanently": "ہمیشہ کے لیے حذف کریں",
  "trash.deleteConfirm.title": "ہمیشہ کے لیے حذف کریں؟",
  "trash.deleteConfirm.description": "اس سے \"{{title}}\" اور اس کی ٹرانسکرپٹ، واقعات، ہداف، لیجر، اور ملکیت مانیٹر ریکارڈز ہمیشہ کے لیے حذف ہو جائیں گے۔ اسے واپس نہیں لایا جا سکتا۔",

  "session.tab.session": "سیشن",
  "session.tab.review": "جائزہ لیں",
  "session.tab.context": "سیاق و سباق",
  "session.tab.goal": "مقصد",
