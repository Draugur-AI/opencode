export const dict: Record<string, string> = {
  ...
  "goal.objective.title": "ඉලක්කය",
  "goal.objective.placeholder": "මෙම සැසියෙන් අපේක්ෂිත ප්‍රතිඵලය කුමක්ද?",
  "goal.empty": "මෙම සැසිය සඳහා තවමත් ඉලක්කයක් සකසා නැත.",
  "goal.setGoal": "ඉලක්කය සකසන්න",
  "goal.acceptanceCriteria.title": "ග්‍රහණය කරගැනීමේ මානදණ්ඩ",
  "goal.acceptanceCriteria.empty": "තවමතත් ග්‍රහණය කරගැනීමේ මානදණ්ඩ නොමැත.",
  "goal.acceptanceCriteria.met": "සපුරා ඇත",
  "goal.acceptanceCriteria.waive": "ඉවත් කරන්න",
  "goal.constraints.title": "පැලදුම්",
  "goal.constraints.empty": "තවමතත් පැලදුම් නොමැත.",
  "goal.constraints.fromMessage": "පණිවිඩයෙන්",
  "goal.status.title": "තත්ත්වය",
  "goal.toast.objectiveRequired": "ඉලක්කය හිස් විය නොහැක",
  "goal.toast.saved": "ඉලක්කය සුරකින ලදී",
  "goal.ledger.title": "වැඩ සටහන",
  "goal.ledger.empty": "තවමතත් වැඩ සටහනට ඇතුලත් කිරීම් නොමැත.",
  "goal.ledger.supersede": "අපේක්ෂිත",
  "command.session.goal": "ඉලක්කය සහ වැඩ සටහන",
  "command.session.goal.description": "සැසි ඉලක්කය සහ වැඩ සටහන පැනලය විවෘත කරන්න",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "සේවයන්",
  "home.inventory.favorites": "අභිමත",
  "home.inventory.recent": "ඉතා මෑතකදී",
  "home.inventory.all": "සියල්ල",
  "home.inventory.favorite": "අභිමත වලට එකතු කරන්න",
  "home.inventory.unfavorite": "අභිමත වලින් ඉවත් කරන්න",
  ...
  "archived.title": "සංරක්ෂිත",
  "archived.empty": "සංරක්ෂිත සැසි නැත",
  "trash.title": "අපද්‍රව්‍ය",
  "trash.empty": "අපද්‍රව්‍ය හිස්ය",
  "trash.deletePermanently": "ස්ථායීව මකන්න",
  "trash.deleteConfirm.title": "ස්ථායීව මකනුද?",
  "trash.deleteConfirm.description": "මෙය \"{{title}}\" සහ එහි සංග්‍රහය, සිදුවීම්, අරමුණු, ledger, හිමි monitoring වාර්තා ස්ථායීව මකයි. මෙය කිසිසේත්ම පසුපසට ගෙන යා නොහැක.",
  "session.tab.session": "සැසිය",
  "session.tab.review": "සමාලෝචනය කරන්න",
  "session.tab.context": "සන්දර්භය",
  "session.tab.goal": "ඉලකකය",
  ...
  "common.delete": "මකන්න",
  "common.restore": "ප්‍රතිස්ථාපනය කරන්න",
  "common.close": "වසන්න",
  "common.edit": "සංස්කරණය කරන්න",
  "common.add": "එකක් කරන්න",
