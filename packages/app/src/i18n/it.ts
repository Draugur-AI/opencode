export const dict = {
  ...
  "command.session.goal": "Obiettivo e registro",
  "command.session.goal.description": "Apri il pannello dell'obiettivo della sessione e del registro di lavoro",
  ...
  "goal.objective.title": "Obiettivo",
  "goal.objective.placeholder": "Cosa intende raggiungere questa sessione?",
  "goal.empty": "Nessun obiettivo impostato per questa sessione.",
  "goal.setGoal": "Imposta obiettivo",
  "goal.acceptanceCriteria.title": "Criteri di accettazione",
  "goal.acceptanceCriteria.empty": "Nessun criterio di accettazione.",
  "goal.acceptanceCriteria.met": "Raggiunto",
  "goal.acceptanceCriteria.waive": "Escludi",
  "goal.constraints.title": "Vincoli",
  "goal.constraints.empty": "Nessun vincolo.",
  "goal.constraints.fromMessage": "Dal messaggio",
  "goal.status.title": "Stato",
  "goal.toast.objectiveRequired": "L'obiettivo non può essere vuoto",
  "goal.toast.saved": "Obiettivo salvato",
  "goal.ledger.title": "Registro di lavoro",
  "goal.ledger.empty": "Nessuna voce di registro.",
  "goal.ledger.supersede": "Sostituisci",
  ...
  "home.inventory.servers": "Server",
  "home.inventory.favorites": "Preferiti",
  "home.inventory.recent": "Recenti",
  "home.inventory.all": "Tutti",
  "home.inventory.favorite": "Aggiungi ai preferiti",
  "home.inventory.unfavorite": "Rimuovi dai preferiti",
  ...
  "trash.deleteConfirm.title": "Eliminare definitivamente?",
  "trash.deleteConfirm.description": "Questo elimina definitivamente \"{{title}}\" e la relativa trascrizione, eventi, obiettivi, record del registro e monitor. Questa operazione non può essere annullata.",
  "session.tab.session": "Sessione",
  "session.tab.review": "Revisione",
  "session.tab.context": "Contesto",
  "session.tab.goal": "Obiettivo",
