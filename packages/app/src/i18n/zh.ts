...
export const dict = {
  ...
  "home.inventory.servers": "服务器",
  "home.inventory.favorites": "收藏夹",
  "home.inventory.recent": "最近",
  "home.inventory.all": "全部",
  "home.inventory.favorite": "添加到收藏夹",
  "home.inventory.unfavorite": "从收藏夹移除",
  ...
  "trash.deleteConfirm.title": "永久删除？",
  "trash.deleteConfirm.description": "这将永久删除 \"{{title}}\" 及其转录、事件、目标、分类账和监控记录。此操作无法撤销。",
  "common.restore": "还原",
