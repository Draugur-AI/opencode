...
export const dict = {
  ...
  "goal.objective.title": "Cilj",
  "goal.objective.placeholder": "Što ova sesija želi postići?",
  "goal.empty": "Za ovu sesiju još nije postavljen cilj.",
  "goal.setGoal": "Postavi cilj",
  "goal.acceptanceCriteria.title": "Kriteriji prihvaćanja",
  "goal.acceptanceCriteria.empty": "Još nema kriterija prihvaćanja.",
  "goal.acceptanceCriteria.met": "Ispunjeno",
  "goal.acceptanceCriteria.waive": "Odustani",
  "goal.constraints.title": "Ograničenja",
  "goal.constraints.empty": "Još nema ograničenja.",
  "goal.constraints.fromMessage": "Iz poruke",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Cilj ne može biti prazan",
  "goal.toast.saved": "Cilj je spremljen",
  "goal.ledger.title": "Radni knjigovodstvo",
  "goal.ledger.empty": "Još nema unosa u knjigovodstvu.",
  "goal.ledger.supersede": "Naslijedi",
  "session.tab.goal": "Cilj",
  "command.session.goal": "Cilj i knjigovodstvo",
  "command.session.goal.description": "Otvorite panel za cilj sesije i radno knjigovodstvo",
  ...
  "home.inventory.servers": "Poslužitelji",
  "home.inventory.favorites": "Omiljeni",
  "home.inventory.recent": "Nedavni",
  "home.inventory.all": "Svi",
  "home.inventory.favorite": "Dodaj u omiljene",
  "home.inventory.unfavorite": "Ukloni iz omiljenih",
  ...
  "trash.title": "Smaće",
  "trash.empty": "Smaće je prazno",
  "trash.deletePermanently": "Trajno izbriši",
  "trash.deleteConfirm.title": "Trajno izbrisati?",
  "trash.deleteConfirm.description": "Ovim se trajno briše \"{{title}}\" i njegov transkript, događaji, ciljevi, knjižnica i posjedovani zapisi monitora. Ovo se ne može poništiti.",
