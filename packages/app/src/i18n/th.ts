export const dict = {
  ...
  "command.session.goal": "จุดเปล้ำ & บัญชีรายการ",
  "command.session.goal.description": "เปิดแผงจุดเปล้ำและบัญชีรายการของเซสชัน",
  ...
  "home.inventory.servers": "เซิร์ฟเวอร์",
  "home.inventory.favorites": "รายการที่ถุกใจ",
  "home.inventory.recent": "ล่าสุด",
  "home.inventory.all": "ทั้งหมด",
  "home.inventory.favorite": "เพิ่มลงในรายการที่ถุกใจ",
  "home.inventory.unfavorite": "เลิกถุกใจ",
  ...
  "goal.objective.title": "วัตถุประสงค์",
  "goal.objective.placeholder": "เซสชันนี้พยายามทำสิ่งใด?",
  "goal.empty": "ยังไม่ได้กำหนดเป้าหมายสำหรับเซสชันที้",
  "goal.setGoal": "กำหนดเป้าหมาย",
  "goal.acceptanceCriteria.title": "เกณฑ์การยอมรับ",
  "goal.acceptanceCriteria.empty": "ยังไม่มีเกณฑ์การยอมรับ",
  "goal.acceptanceCriteria.met": "ผ่าน",
  "goal.acceptanceCriteria.waive": "ยกเว้น",
  "goal.constraints.title": "ข้อจำกัด",
  "goal.constraints.empty": "ยังไม่มีข้อจำกัด",
  "goal.constraints.fromMessage": "จากข้อความ",
  "goal.status.title": "สถานะ",
  "goal.toast.objectiveRequired": "วัตถุประสงค์ไม่สามารถว่างเปล่าได้",
  "goal.toast.saved": "บันทึกเป้าหมายแลว้",
  "goal.ledger.title": "บัญชีรายการ",
  "goal.ledger.empty": "ยังไม่มีรายการในบัญชีรายการ",
  "goal.ledger.supersede": "แทนที่",
  "session.tab.goal": "เป้าหมาย",
  "common.add": "เพิ่พม",
}
