export const dict = {
  ...
  "command.session.goal": "Cilj i vodilja",
  "command.session.goal.description": "Otvori panel cilja sesije i radne vodilje",
  ...
  "goal.objective.placeholder": "Šta ova sesija treba postići?",
  "goal.empty": "Za ovu sesiju još nije postavljen cilj.",
  "goal.setGoal": "Postavi cilj",
  "goal.acceptanceCriteria.title": "Kriteriji prihvatanja",
  "goal.acceptanceCriteria.empty": "Još nema kriterija prihvatanja.",
  "goal.acceptanceCriteria.met": "Zadovoljen",
  "goal.acceptanceCriteria.waive": "Odbojan",
  ...
  "goal.toast.saved": "Cilj je sačuvan",
  "goal.ledger.title": "Radna vodilja",
  "goal.ledger.empty": "Još nema unosa u radnu vodilju.",
  "goal.ledger.supersede": "Zamijeni",
