export const dict = {
  ...
  "command.session.goal": "Mục tiêu & sổ cái",
  "command.session.goal.description": "Mở bảng mục tiêu phiên và sổ cái hoạt động",
  ...
  "goal.objective.title": "Mục tiêu",
  "goal.objective.placeholder": "Phiên này đang cố đạt được điều gì?",
  "goal.empty": "Chưa đặt mục tiêu cho phiên này.",
  "goal.setGoal": "Đặt mục tiêu",
  "goal.acceptanceCriteria.title": "Tiêu chí chấp nhận",
  "goal.acceptanceCriteria.empty": "Chưa có tiêu chí chấp nhận nào.",
  "goal.acceptanceCriteria.met": "Đạt",
  "goal.acceptanceCriteria.waive": "Miễn",
  "goal.constraints.title": "Ràng buộc",
  "goal.constraints.empty": "Chưa có ràng buộc nào.",
  "goal.constraints.fromMessage": "Từ tin nhắn",
  "goal.status.title": "Trạng thái",
  "goal.toast.objectiveRequired": "Mục tiêu không được để trống",
  "goal.toast.saved": "Đã lưu mục tiêu",
  "goal.ledger.title": "Sổ cái hoạt động",
  "goal.ledger.empty": "Chưa có mục nào trong sổ cái.",
  "goal.ledger.supersede": "Thay thế",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "archived.empty": "Không có phiên nào đã lưu trữ",
  "trash.title": "Thùng rác",
  "trash.empty": "Thùng rác trống",
  "trash.deletePermanently": "Xóa vĩnh viễn",
  "trash.deleteConfirm.title": "Xóa vĩnh viễn?",
  "trash.deleteConfirm.description": "Thao tác này sẽ xóa vĩnh viễn \"{{title}}\" và bản ghi, sự kiện, mục tiêu, sổ cái, và các bản ghi theo dõi thuộc sở hữu của nó. Không thể hoàn tác.",
  "home.inventory.servers": "Máy chủ",
  "home.inventory.favorites": "Yêu thích",
  "home.inventory.recent": "Gần đây",
  "home.inventory.all": "Tất cả",
  "home.inventory.favorite": "Thêm vào yêu thích",
  "home.inventory.unfavorite": "Bỏ khỏi yêu thích",
  "session.tab.session": "Phiên",
  "session.tab.review": "Xem lại",
  "session.tab.context": "Ngữ cảnh",
  "session.tab.goal": "Mục tiêu",
