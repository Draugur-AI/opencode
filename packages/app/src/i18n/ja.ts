export const dict = {
  ...
  "command.session.goal.description": "セッションのGoalとワーキングライジスタパネルを開く",
  ...
  "goal.objective.placeholder": "このセッションの目標は何ですか？",
  "goal.empty": "このセッションにはまだ目標が設定されていません。",
  "goal.setGoal": "目標を設定",
  "goal.acceptanceCriteria.title": "Acceptance criteria",
  "goal.acceptanceCriteria.empty": "Acceptance criteriaはありません。",
  "goal.acceptanceCriteria.met": "Met",
  "goal.acceptanceCriteria.waive": "Waive",
  "goal.constraints.title": "Constraints",
  "goal.constraints.empty": "Constraintsはありません。",
  "goal.constraints.fromMessage": "From message",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Objectiveは空にできません",
  "goal.toast.saved": "Goal saved",
  "goal.ledger.title": "ワーキングライジスタ",
  "goal.ledger.empty": "ライジスタエントリはありません。",
  ...
  "home.inventory.servers": "サーバー",
  "home.inventory.favorites": "お気に入り",
  "home.inventory.recent": "最近更新",
  "home.inventory.all": "すべて",
  "home.inventory.favorite": "お気に入りに追加",
  "home.inventory.unfavorite": "お気に入りから削除",
  ...
  "archived.empty": "アーカイブされたセッションはありません",
  "trash.title": "ゴミ箱",
  "trash.empty": "ゴミ箱は空です",
  "trash.deletePermanently": "完全に削除",
  "trash.deleteConfirm.title": "完全に削除しますか？",
  "trash.deleteConfirm.description": "これにより、「{{title}}」とその会話記録、イベント、ゴール、ledger、所有するモニター記録が完全に削除されます。この操作は元に戻せません。",
