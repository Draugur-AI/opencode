export const dict = {
  ...
  "archived.empty": "Нема архивирани сесии",
  "trash.title": "Канта за отпад",
  "trash.empty": "Кантата за отпад е празна",
  "trash.deletePermanently": "Избриши трајно",
  "trash.deleteConfirm.title": "Да се избрише трајно?",
  "trash.deleteConfirm.description": "Ова трајно го брише „{{title}}“ и неговиот препис, настани, цели, одредник и записи на надгледувач што ги поседува. Ова не може да се поништи.",
