export const dict: Record<string, string> = {
  ...
  "home.inventory.servers": "সার্ভার",
  "home.inventory.favorites": "পছন্দসমূহ",
  "home.inventory.recent": "সাম্প্রতিক",
  "home.inventory.all": "সব",
  "home.inventory.favorite": "পছন্দসমূহে যোগ করুন",
  "home.inventory.unfavorite": "পছন্দসমূহ থেকে সরান",
  ...
  "archived.title": "আর্কাইভ",
  "archived.empty": "কোনো আর্কাইভকৃত সেশন নেই",
  "trash.title": "ট্র্যাশ",
  "trash.empty": "ট্র্যাশ খালি",
  "trash.deletePermanently": "চিরস্থায়ভাবে মুছুন",
  "trash.deleteConfirm.title": "চিরস্থায়ভাবে মুছবেন?",
  "trash.deleteConfirm.description": "এটি স্থায়ভাবে \"{{title}}\" এবং এর ট্রান্সক্রিপ্ট, ইভেন্টস, গোলস, লেজার, এবং মনিটর রেকর্ড মুছে ফেলবে। এটি পূর্বাবস্থায় ফেরানো যাবে না।",
