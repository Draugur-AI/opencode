export const dict = {
  ...
  "command.session.goal": "Obiectiv și registrar",
  "command.session.goal.description": "Deschide panoul de obiectiv al sesiunii și registrarul de lucru",
  ...
  "goal.objective.title": "Obiectiv",
  "goal.objective.placeholder": "Ce încearcă să realizeze această sesiune?",
  "goal.empty": "Niciun obiectiv stabilit încă pentru această sesiune.",
  "goal.setGoal": "Stabilește obiectivul",
  "goal.acceptanceCriteria.title": "Criterii de acceptare",
  "goal.acceptanceCriteria.empty": "Niciun criteriu de acceptare încă.",
  "goal.acceptanceCriteria.met": "Îndeplinit",
  "goal.acceptanceCriteria.waive": "Exonerare",
  "goal.constraints.title": "Constrângeri",
  "goal.constraints.empty": "Nicio constrângere încă.",
  "goal.constraints.fromMessage": "Din mesaj",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Obiectivul nu poate fi gol",
  "goal.toast.saved": "Obiectiv salvat",
  "goal.ledger.title": "Registrar de lucru",
  "goal.ledger.empty": "Nicio înregistrare în registrar încă.",
  "goal.ledger.supersede": "Înlocuiește",
  "session.tab.goal": "Obiectiv",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.favorites": "Favorite",
  "home.inventory.recent": "Recente",
  "home.inventory.all": "Toate",
  "home.inventory.favorite": "Adaugă la favorite",
  "home.inventory.unfavorite": "Elimină din favorite",
  ...
  "archived.title": "Arhivate",
  "archived.empty": "Nicio sesiune arhivată",
  "trash.title": "Coș de gunoi",
  "trash.empty": "Coșul de gunoi este gol",
  "trash.deletePermanently": "Șterge definitiv",
  "trash.deleteConfirm.title": "Ștergi definitiv?",
  "trash.deleteConfirm.description": "Acest lucru va șterge definitiv „{{title}}” și transcrierea, evenimentele, obiectivele, registrul și înregistrările de monitorizare deținute. Această acțiune nu poate fi anulată.",
