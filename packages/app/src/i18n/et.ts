export const dict = {
  ...
  "command.session.goal": "Eesmärk ja dokumentatsioon",
  "command.session.goal.description": "Ava seansi eesmärgi ja töödokumentatsiooni paneel",
  ...
  "goal.objective.title": "Eesmärk",
  "goal.objective.placeholder": "Mida see seanss saavutada soovib?",
  "goal.empty": "Selle seansi jaoks pole eesmärki veel seatud.",
  "goal.setGoal": "Sea eesmärk",
  "goal.acceptanceCriteria.title": "Aktsepteerimiskriteeriumid",
  "goal.acceptanceCriteria.empty": "Aktsepteerimiskriteeriumeid veel pole.",
  "goal.acceptanceCriteria.met": "Täidetud",
  "goal.acceptanceCriteria.waive": "Jäta kõrvale",
  "goal.constraints.title": "Piirangud",
  "goal.constraints.empty": "Piiranguid veel pole.",
  "goal.constraints.fromMessage": "Sõnumist",
  "goal.status.title": "Olek",
  "goal.toast.objectiveRequired": "Eesmärk ei tohi olla tühi",
  "goal.toast.saved": "Eesmärk salvestatud",
  "goal.ledger.title": "Töödokumentatsioon",
  "goal.ledger.empty": "Dokumentatsiooni kirjeid veel pole.",
  "goal.ledger.supersede": "Asenda",
  ...
  "home.inventory.servers": "Serverid",
  "home.inventory.favorites": "Lemmikud",
  "home.inventory.recent": "Hiljutised",
  "home.inventory.all": "Kõik",
  "home.inventory.favorite": "Lisa lemmikutesse",
  "home.inventory.unfavorite": "Eemalda lemmikutest",
  ...
  "archived.title": "Arhiiv",
  "archived.empty": "Ühtegi arhiveeritud seanssi pole",
  "trash.title": "Prügi",
  "trash.empty": "Prügikast on tühi",
  "trash.deletePermanently": "Kustuta lõplikult",
  "trash.deleteConfirm.title": "Kas kustutada lõplikult?",
  "trash.deleteConfirm.description": "See kustutab \"{{title}}\" ja selle transkriptsiooni, sündmused, eesmärgid, ledgeri ning valitsetavad monitori kirjed lõplikult. Seda ei saa tagasi võtta.",
  "session.tab.session": "Seanss",
  "session.tab.review": "Ülevaade",
  "session.tab.context": "Kontekst",
  "session.tab.goal": "Eesmärk",
