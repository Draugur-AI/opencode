...
export const dict = {
  ...
  "command.session.goal": "目標與紀錄",
  "command.session.goal.description": "開啟工作階段目標與工作紀錄面板",
  ...
  "goal.objective.title": "目標",
  "goal.objective.placeholder": "這個工作階段要完成什麼？",
  "goal.empty": "這個工作階段尚未設定目標。",
  "goal.setGoal": "設定目標",
  "goal.acceptanceCriteria.title": "驗收標準",
  "goal.acceptanceCriteria.empty": "尚未有驗收標準。",
  "goal.acceptanceCriteria.met": "已達成",
  "goal.acceptanceCriteria.waive": "豁免",
  "goal.constraints.title": "限制條件",
  "goal.constraints.empty": "尚未有限制條件。",
  "goal.constraints.fromMessage": "來自訊息",
  "goal.status.title": "狀態",
  "goal.toast.objectiveRequired": "目標不能為空",
  "goal.toast.saved": "目標已儲存",
  "goal.ledger.title": "工作紀錄",
  "goal.ledger.empty": "尚未有紀錄項目。",
  "goal.ledger.supersede": "取代",
  ...
  "home.inventory.servers": "伺服器",
  "home.inventory.favorites": "最愛",
  "home.inventory.recent": "最近",
  "home.inventory.all": "全部",
  "home.inventory.favorite": "加至最愛",
  "home.inventory.unfavorite": "從最愛移除",
