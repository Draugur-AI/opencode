export const dict = {
  ...
  "command.session.goal": "Cilj in dnevnik",
  "command.session.goal.description": "Odpri panel cilja seje in delovnega dnevnika",
  ...
  "goal.objective.title": "Objektiv",
  "goal.objective.placeholder": "Kaj želi ta seja doseči?",
  "goal.empty": "Za to sejo še ni cilja.",
  "goal.setGoal": "Nastavi cilj",
  "goal.acceptanceCriteria.title": "Kriteriji za sprejetje",
  "goal.acceptanceCriteria.empty": "Še ni kriterijev za sprejetje.",
  "goal.acceptanceCriteria.met": "Izpolnjen",
  "goal.acceptanceCriteria.waive": "Odstopi",
  "goal.constraints.title": "Omejitve",
  "goal.constraints.empty": "Še ni omejitev.",
  "goal.constraints.fromMessage": "Iz sporočila",
  "goal.status.title": "Stanje",
  "goal.toast.objectiveRequired": "Objektiv ne sme biti prazen",
  "goal.toast.saved": "Cilj shranjen",
  "goal.ledger.title": "Delovni dnevnik",
  "goal.ledger.empty": "Še vnosa v dnevniku.",
  "goal.ledger.supersede": "Nadomesti",
  ...
  "home.inventory.servers": "Strežniki",
  "home.inventory.favorites": "Priljubljene",
  "home.inventory.recent": "Nedavni",
  "home.inventory.all": "Vsi",
  "home.inventory.favorite": "Dodaj med priljubljene",
  "home.inventory.unfavorite": "Odstrani iz priljubljenih",
  ...
  "archived.title": "Arhivirano",
  "archived.empty": "Ni arhiviranih sej",
  "trash.title": "Zmet",
  "trash.empty": "Zmet je prazna",
  "trash.deletePermanently": "Trajno izbriši",
  "trash.deleteConfirm.title": "Trajno izbrisati?",
  "trash.deleteConfirm.description": "To trajno izbriše »{{title}}« in njegov zapis, dogodke, cilje, knjigo vodil in lastne nadzorne zapise. To ni mogoče razveljaviti.",
  "session.tab.session": "Seja",
  "session.tab.review": "Pregled",
  "session.tab.context": "Kontekst",
  "session.tab.goal": "Cilj",
