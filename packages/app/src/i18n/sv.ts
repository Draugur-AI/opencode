export const dict = {
  ...
  "command.session.goal": "Mål &ledger",
  "command.session.goal.description": "Öppna panelen för sessionsmål och arbetsledger",
  ...
  "goal.objective.placeholder": "Vad försöker denna session uppnå?",
  "goal.empty": "Inget mål har angetts för denna session ännu.",
  "goal.setGoal": "Ange mål",
  "goal.acceptanceCriteria.title": "Acceptanskriterier",
  "goal.acceptanceCriteria.empty": "Inga acceptanskriterier ännu.",
  "goal.acceptanceCriteria.met": "Uppfyllt",
  "goal.acceptanceCriteria.waive": "Åkallan",
  "goal.constraints.title": "Begränsningar",
  "goal.constraints.empty": "Inga begränsningar ännu.",
  "goal.constraints.fromMessage": "Från meddelande",
  "goal.status.title": "Status",
  "goal.toast.objectiveRequired": "Objektivet kan inte vara tomt",
  "goal.toast.saved": "Mål sparat",
  "goal.ledger.title": "Arbetsledger",
  "goal.ledger.empty": "Inga ledger-poster ännu.",
  "goal.ledger.supersede": "Ersätt",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "home.inventory.servers": "Servrar",
  "home.inventory.favorites": "Favoriter",
  "home.inventory.recent": "Senaste",
  "home.inventory.all": "Alla",
  "home.inventory.favorite": "Lägg till i favoriter",
  "home.inventory.unfavorite": "Ta bort från favoriter",
  ...
  "archived.title": "Arkiverade",
  "archived.empty": "Inga arkiverade sessioner",
  "trash.title": "Papperskorg",
  "trash.empty": "Papperskorgen är tom",
  "trash.deletePermanently": "Radera permanent",
  "trash.deleteConfirm.title": "Radera permanent?",
  "trash.deleteConfirm.description": "Detta raderar permanent \"{{title}}\" och dess transkript, händelser, mål, ledger och ägda monitorposter. Detta kan inte ångras.",
  "session.tab.session": "Session",
  "session.tab.review": "Granskning",
  "session.tab.context": "Kontext",
  "session.tab.goal": "Mål",
