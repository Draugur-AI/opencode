...
The model ID in your OpenCode config uses the format `provider/model-id`. For example, if you're using Anthropic, you would use `anthropic/claude-sonnet-4-20250514`.
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/Draugur-AI/opencode).
:::
