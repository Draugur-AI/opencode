...
You can define MCP servers in your [OpenCode Config](/docs/config) under `mcp`. Add each MCP with a unique name. You can refer to that MCP by name when prompting the LLM.
