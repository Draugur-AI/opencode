...
1. Run the `/connect` command in the TUI and select your provider.

   ```txt
   /connect
   ```

2. Follow the provider's own sign-in flow, then paste your API key.
...
See the [full list of supported providers](/docs/providers#directory).
